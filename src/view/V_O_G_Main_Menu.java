	...
	public V_O_G_Main_Menu() {
		...
		BTN_Goto_RegMem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FRM_MM.dispose();
				V_O_G_Reg_Mem OGRM = new V_O_G_Reg_Mem();
			}
		});
		...
		BTN_Goto_Brwr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				FRM_MM.dispose();
				V_O_G_Borrow_Book OGBB = new V_O_G_Borrow_Book();
			}
		});
		...
		BTN_Goto_RegBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FRM_MM.dispose();
				V_O_G_Reg_Book OGRB = new V_O_G_Reg_Book();
			}
		});
		...
		BTN_Goto_RnwMem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FRM_MM.dispose();
				V_O_G_Mem_Pay OGMP = new V_O_G_Mem_Pay();
			}
		});
